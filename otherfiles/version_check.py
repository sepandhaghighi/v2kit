...
README_ITEMS = [
    "[Version {0}](https://github.com/sepandhaghighi/v2kit/archive/v{0}.zip)",
    "pip install v2kit=={0}"]

SETUP_ITEMS = [
    "version='{0}'",
    "https://github.com/sepandhaghighi/v2kit/tarball/v{0}"]

CHANGELOG_ITEMS = [
    "## [{0}]",
    "https://github.com/sepandhaghighi/v2kit/compare/v{0}...dev",
    "[{0}]:"]

PARAMS_ITEMS = ['V2KIT_VERSION = "{0}"']
ISSUE_TEMPLATE_ITEMS = ["- V2Kit {0}"]
